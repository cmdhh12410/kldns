-- KLDNS D1 Database Schema
-- Consolidated from all Go migrations
...
CREATE INDEX IF NOT EXISTS idx_domains_provider_key ON domains(provider_key);

-- Subdomains table (with review support)
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_subdomains_live_unique ON subdomains(did, name) WHERE status IN (0, 1, 2);
...
CREATE INDEX IF NOT EXISTS idx_subdomains_reviewed_by ON subdomains(reviewed_by);
...
CREATE INDEX IF NOT EXISTS idx_api_tokens_uid ON api_tokens(uid);
...
-- Point Records table (with admin_uid)
...
CREATE INDEX IF NOT EXISTS idx_point_records_uid ON point_records(uid);
CREATE INDEX IF NOT EXISTS idx_point_records_admin_uid ON point_records(admin_uid);
CREATE INDEX IF NOT EXISTS idx_point_records_action ON point_records(action);
...
CREATE INDEX IF NOT EXISTS idx_operation_logs_uid ON operation_logs(uid);
CREATE INDEX IF NOT EXISTS idx_operation_logs_admin_uid ON operation_logs(admin_uid);
CREATE INDEX IF NOT EXISTS idx_operation_logs_source ON operation_logs(source);
CREATE INDEX IF NOT EXISTS idx_operation_logs_action ON operation_logs(action);
CREATE INDEX IF NOT EXISTS idx_operation_logs_created_at ON operation_logs(created_at DESC);

-- DNS Write Jobs table
...
CREATE INDEX IF NOT EXISTS idx_dns_write_jobs_status ON dns_write_jobs(status);
CREATE INDEX IF NOT EXISTS idx_dns_write_jobs_provider ON dns_write_jobs(provider_key);
